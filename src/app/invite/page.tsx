...
import { InviteLinkIniput } from './invite-link-input'


export default function InvitePage(){

    const inviteLink = 'http:/localhost:300/invite/123354256'

    return(
        <div className="min-h-dvh flex items-center justify-between gap-16 flex-col md:flex-row">
            <div className="flex flex-col gap-10 w-full max-w-[550px]">
                <Image src={logo} alt="devstage" width={108.5} height={30}></Image>
                ...
                <div className='space-y-6'>
                    ...
                    <InviteLinkIniput inviteLink={inviteLink} />
